...
% function do_comppos_a_f(basepath,altpath,triallist,kanallist,comp_sensor,auto_flag,diaryfile)
% DO_COMPPOS_A_F Auxiliary function to run comppos_fm and plot statistics
...
%
%   See Also
%       COMPPOS_FM The function that actually does most of the work
...
functionname='do_comppos_a_f: Version 31.3.09';
