function [posamprms,posampdt,eucaa,eucpa]=posampana_sig(amps,posamps,rmsfac);
% POSAMPANA_SIG rms error and dt difference from amps and posamps. Also
% tangvel of amps and posamps
