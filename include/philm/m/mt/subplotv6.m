function theAxis = subplotv6(nrows, ncols, thisPlot, replace)
%SUBPLOTV6 Create axes in tiled positions (for use with subp_pos)
%   Phil: this is a copy of the matlab 6 version of subplot
%       for use with subp_pos (see there for explanations)
