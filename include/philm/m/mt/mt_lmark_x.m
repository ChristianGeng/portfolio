...
functionname='mt_lmark: Version 9.3.09';
...
%also insert in the output version of the mt cut data
		...
		if ichange
			...
			usercomment=['Segments in marker file : ' int2str(ncut) crlf orgdat.session_comment_base crlf usercomment];
