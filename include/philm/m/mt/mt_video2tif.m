function mt_video2tif(outfile,timspec,delayfac,idown,wienerorder)
% MT_VIDEO2TIF Run video display and store as series of tif images, linking video and sonagram displays
% function mt_video2tif(outfile,timspec,delayfac,idown,wienerorder)
%	MT_VIDEO2TIF: Version 4.3.2001
%
% Syntax
