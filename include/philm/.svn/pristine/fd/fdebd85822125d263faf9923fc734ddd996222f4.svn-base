...
% CONVERTTDMS_PH Version 25.10.2012
%
%   Description
...
%       Data with no decimation level information are returned as in the
...
functionname=['converttdms_ph: Version 25.10.2012 (from original version ' ConvertVer ')'];
    ConvertedData=[];
    SaveConvertedFile=1;
...
for kk=1:length(fnm)
    ...
    if id.rawdatacount>0
        ...
        %module somewhere??)
        %And what about digital signals if it proves possible to handle them?
